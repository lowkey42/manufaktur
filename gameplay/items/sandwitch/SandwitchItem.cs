...
public partial class SandwitchItem : DurationItemResource {
	...
	public override void Use(Player player) {
		...
		var spawnPosition = player.GlobalPosition + player.GetFacingDirection().Normalized() * SpawnForwardOffset + Vector3.Up * SpawnUpOffset;
		...
		throwable.ShowDebugShockwave  = false;
		throwable.ShowTimerDisplay    = true;
