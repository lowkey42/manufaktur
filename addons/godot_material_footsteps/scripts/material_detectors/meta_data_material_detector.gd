...
func detect(raycast: RayCast3D) -> Variant:
	...
	# hello there... I'm a hack because the material detection is buggy and my programmer couldn't be bothered to implement a proper solution
	# ¯\_(ツ)_/¯
...
func _detect_material_on_object(obj: Object) -> Variant:
	...
	if obj is MeshInstance3D:
		var mat := (obj as MeshInstance3D).get_active_material(0)
		if mat:
			if mat.has_meta("surface_type"):
				var meta := mat.get_meta("surface_type")
				if _valid_materials_set.has(meta):
					return meta
