...
public class ResourceGroup {
	...
	public List<Resource> LoadAll() {
		return new List<Resource>(_wrapped.Call("load_all").AsGodotObjectArray<Resource>());
	}
	...
	public List<string> GetMatchingPaths(IEnumerable<string> includes, IEnumerable<string> excludes) {
		return new List<string>(_wrapped.Call("__csharp_get_matching_paths", ToArray(includes), ToArray(excludes)).AsStringArray());
	}
	...
	public List<Resource> LoadMatching(IEnumerable<string> includes, IEnumerable<string> excludes) {
		return new List<Resource>(_wrapped.Call("__csharp_load_matching", ToArray(includes), ToArray(excludes))
